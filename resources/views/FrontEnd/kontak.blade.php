        ...
        <section class="bg-white dark:bg-gray-900">
            <div class="py-8 lg:py-16 px-4 mx-auto max-w-screen-md">
                ...
                <form action="#" class="space-y-8">
                    ...
                    <center><button type="submit" class="bg-emerald-400 py-3 px-5 text-sm font-medium text-center text-white rounded-lg bg-primary-700 sm:w-fit hover:bg-emerald-700 focus:ring-4 focus:outline-none focus:ring-primary-300 dark:bg-primary-600 dark:focus:ring-primary-800">Send message</button></center>
                </form>
            </div>
          </section>
    </div>
