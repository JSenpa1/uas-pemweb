        ...
        <div class="w-full max-w-sm bg-gray-800 border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700 sm:pt-6">
            <div class="flex flex-col items-center pb-10">
                ...
                <div class="flex mt-4 md:mt-6">
                    ...
                    <a href="#" class="inline-flex items-center px-4 py-2 text-sm font-medium text-center  text-white bg-red-600 hover:bg-red-800 rounded-lg focus:ring-4 focus:outline-none ms-3">Delete</a>
                </div>
            </div>
        </div>
